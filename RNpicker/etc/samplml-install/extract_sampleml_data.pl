...
$ex->extract('RMSMAN.GARDS_NUCL2QUANTIFY','GARDS_NUCL2QUANTIFY',\%TRANSHASH);

print "\n\n------------------ Get Dynamic Data ------------------\n\n";

print "extract part of IDCX.FILEPRODUCT\n";

# get data from FILEPRODUCT for a particular sample
$ex->extract('IDCX.FILEPRODUCT','FILEPRODUCT',\%TRANSHASH,'select * from IDCX.FIlEPRODUCT fprod where fprod.chan=?',$SAMPLEID);

print "extract RMSMAN.GARDS_PRODUCT\n";

$ex->extract('RMSMAN.GARDS_PRODUCT','GARDS_PRODUCT',\%TRANSHASH,'select * from RMSMAN.GARDS_PRODUCT where sample_id=?',$SAMPLEID);

print "extract part of GARDS_SAMPLE_PROC_PARAMS\n";

# get data from GARDS_SAMPLE_PROC_PARAMS for a particular sample
$ex->extract('RMSMAN.GARDS_SAMPLE_PROC_PARAMS','GARDS_SAMPLE_PROC_PARAMS',\%TRANSHASH,'select * from RMSMAN.GARDS_SAMPLE_PROC_PARAMS where sample_id=?',$SAMPLEID);

print "extract part of GARDS_SAMPLE_UPDATE_PARAMS\n";

# get data from GARDS_SAMPLE_UPDATE_PARAMS for a particular sample
$ex->extract('RMSMAN.GARDS_SAMPLE_UPDATE_PARAMS','GARDS_SAMPLE_UPDATE_PARAMS',\%TRANSHASH,'select * from RMSMAN.GARDS_SAMPLE_UPDATE_PARAMS where sample_id=?',$SAMPLEID);

print "extract RMSMAN.GARDS_SAMPLE_DATA \n";
$ex->extract('RMSMAN.GARDS_SAMPLE_DATA','GARDS_SAMPLE_DATA',\%TRANSHASH,'select * from RMSMAN.GARDS_SAMPLE_DATA where sample_id=?',$SAMPLEID);
...
#original request
$ex->extract('RMSMAN.GARDS_SAMPLE_STATUS','GARDS_SAMPLE_STATUS',\%TRANSHASH,'select GSS.* from RMSMAN.GARDS_SAMPLE_STATUS GSS where GSS.SAMPLE_ID=?',$SAMPLEID);
...
$ex->extract('RMSMAN.GARDS_SAMPLE_AUX','GARDS_SAMPLE_AUX',\%TRANSHASH,'select GSS.* from RMSMAN.GARDS_SAMPLE_AUX GSS where GSS.SAMPLE_ID=?',$SAMPLEID);
...
$ex->extract('RMSMAN.GARDS_ENERGY_CAL','GARDS_ENERGY_CAL',\%TRANSHASH,'select GES.* from RMSMAN.GARDS_ENERGY_CAL GES where GES.sample_id =?',$SAMPLEID);
...
=head1 SYNOPSIS
  ...
  Options:
  --sampleID  (-sid)     Sample ID ex -sid 0889826  (no default) 
