...
----------------------------------------------------------------------
--- GARDS_SAMPLE_UPDATE_PARAMS Basic structure
----------------------------------------------------------------------

  CREATE TABLE GARDS_SAMPLE_UPDATE_PARAMS
  (
    SAMPLE_ID                                                       NUMBER,
    MRP_USED                                                        NUMBER,
  ...
  ALTER TABLE GARDS_SAMPLE_UPDATE_PARAMS ADD CONSTRAINT PK_GARDS_UPDATE_PARAM PRIMARY KEY (SAMPLE_ID) ENABLE;

----------------------------------------------------------------------
--- GARDS_SAMPLE_PROC_PARAMS Basic structure
----------------------------------------------------------------------

  CREATE TABLE GARDS_SAMPLE_PROC_PARAMS
  (
    SAMPLE_ID                    NUMBER,
    DO_BACK                      NUMBER,
  ...
  ALTER TABLE GARDS_SAMPLE_PROC_PARAMS ADD CONSTRAINT PK_GARDS_PROC_PARAM PRIMARY KEY (SAMPLE_ID) ENABLE;
----------------------------------------------------------------------
--- GARDS_NUCL2QUANTIFY Basic structure
----------------------------------------------------------------------

  CREATE TABLE GARDS_NUCL2QUANTIFY 
  (
	NAME VARCHAR2(8), 
    DTG_BEGIN  DATE,
    DTG_END    DATE,
  ...
  ALTER TABLE GARDS_NUCL2QUANTIFY ADD CONSTRAINT PK_NUCL2QUANTIFY PRIMARY KEY (NAME) ENABLE;
