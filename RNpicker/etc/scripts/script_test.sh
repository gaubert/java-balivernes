...
#DEFAULT_LIBXML2_DIR=/home/smd/aubert/new-env/ext/clib/libxml2/lib
DEFAULT_LIBXML2_DIR=/usr/lib

#DEFAULT_LIBXSLT_DIR=/home/smd/aubert/new-env/ext/clib/libxslt/lib
DEFAULT_LIBXSLT_DIR=/usr/lib

DEFAULT_RNPICKER_CONF_DIR=$RNPICKER/conf
...
if [ ! -f "$RNPICKER_CONF_DIR/rnpicker.config" ]; then
    echo "RNPICKER_CONF $RNPICKER_CONF_DIR doesn't contain rnpicker.config. generate_arr will try to load it from the CLI argument --conf_dir"
fi
