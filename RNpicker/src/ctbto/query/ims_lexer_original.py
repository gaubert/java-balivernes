...
# essential_criteria
essential_criteria  = ('TECHNOLOGY_FAMILY','TECHNOLOGY_TYPE','PRODUCT_FAMILY','PRODUCT_TYPE','LOCATION','STATION','DATE')
...
tokens = reserved + ( 
    ...
    'ESSENTIAL', 'ID', 'DATETIME', 'NUMBER', 'STRING',   
...
t_STRING = group(dsconst,ssconst)
